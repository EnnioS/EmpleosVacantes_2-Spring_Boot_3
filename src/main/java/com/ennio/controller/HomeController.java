...
import com.ennio.model.Perfil;
import com.ennio.model.Usuario;
import com.ennio.model.Vacante;
import com.ennio.service.ICategoriasService;
import com.ennio.service.IUsuariosService;
import com.ennio.service.IVacantesService;
...
public class HomeController {
	...
	@GetMapping("/index")
	public String mostrarIndex(Authentication auth, HttpSession session)//recupera los datos de autentcacion rn la interfaz Authentication
	{
		...
		if(session.getAttribute("usuario") == null) {
			...
			usuario.setPassword(null);//para no almacenar la contraseña en la sesion
