...
public class DatabaseWebSecurity {
	...
	//leer usuarios y role desde tabla por default "user" y #authorities" DB
	/*@Bean
	UserDetailsManager users(DataSource dataSource) {//Administrador de detalles de uarios lidos por JDBC desde una base de datos
		JdbcUserDetailsManager users = new JdbcUserDetailsManager(dataSource);		
		return users;
	}*/
	
	//recuperar ususarios y perfiles asociados desde la tabla Usuarios y Perfiles creada por nososts desde la base de datos con consultas SQL
